...
- Compiler Explorer 是观察编译器行为的最佳窗口，想系统梳理 GCC/Clang 各选项的效果，见 [卷七·编译器选项](../../../../vol7-engineering/02-compiler-options.md)。
- 在 CE 里看自动向量化如何启用 AVX/AVX2，见 [卷六·AVX/AVX2 深入](../../../../vol6-performance/ch04-tuning-by-bottleneck/04-05-simd.md)。
