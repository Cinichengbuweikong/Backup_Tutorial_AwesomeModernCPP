...
features:
  ...
  - title: "卷二 · 现代特性"
    details: 'C++11/14/17 核心特性深入讲解。区分"现代 C++"和"旧 C++"的关键卷。'
    ...
    link: /vol2-modern-features/
    linkText: 开始阅读

  - title: "卷三 · 标准库深入"
    details: "STL 容器、迭代器、算法深入讲解与源码分析。"
    ...
    link: /vol3-standard-library/
    linkText: 开始阅读

  - title: "卷四 · 高级主题"
    details: "C++20/23/26 高级特性：Concepts、Ranges、协程、模块、模板元编程。"
  ...
  - title: "卷五 · 并发编程"
    details: "从线程原语到协程异步，全面掌握 C++ 并发编程。"
    ...
    link: /vol5-concurrency/
    linkText: 开始阅读

  - title: "卷六 · 性能优化"
    details: "CPU 缓存、SIMD、汇编阅读、优化模式与基准测试。"
    ...
    link: /vol6-performance/
    linkText: 开始阅读

  - title: "卷七 · 工程实践"
    details: "CMake、包管理、测试、静态分析、DevOps。"
    icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>'
    link: /vol7-engineering/
    linkText: 开始阅读
  ...
  - title: "卷九 · 开源项目学习"
    details: "分析真实开源项目源码（如 Chromium），学习工业级 C++ 设计与实现。"
  ...
  - title: "社区文章"
    details: "社区来稿初刊、已审阅收录文章与后续主线整合入口。"
    icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>'
    link: /community/
    linkText: 查看来稿

  - title: "标签索引"
    details: "按标签浏览所有教程文章，方便按主题查找相关内容。"
